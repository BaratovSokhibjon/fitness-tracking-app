...
const programWorkouts = [
  {
    ...
    sortOrder: 0,
    exercises: [
      { name: "Push-ups", type: "BODYWEIGHT", sets: 4, minReps: 10, maxReps: 12, restTime: 90 },
      { name: "Pike Push-ups", type: "BODYWEIGHT", sets: 3, minReps: 8, maxReps: 12, restTime: 90 },
      { name: "Chair Dips", type: "BODYWEIGHT", sets: 3, minReps: 10, maxReps: 15, restTime: 90 },
      { name: "Diamond Push-ups", type: "BODYWEIGHT", sets: 3, minReps: 8, maxReps: 12, restTime: 90 },
    ],
  },
  {
    name: "Pull",
    ...
    sortOrder: 1,
    exercises: [
      { name: "Pull-ups", type: "BODYWEIGHT", sets: 4, minReps: 6, maxReps: 12, restTime: 90 },
      { name: "Backpack Rows", type: "WEIGHTED", sets: 3, minReps: 10, maxReps: 15, restTime: 90 },
      { name: "Reverse Fly", type: "BODYWEIGHT", sets: 3, minReps: 12, maxReps: 15, restTime: 60 },
      { name: "Bicep Curls", type: "WEIGHTED", sets: 3, minReps: 10, maxReps: 15, restTime: 60 },
    ],
  },
  {
    name: "Legs",
    ...
    sortOrder: 2,
    exercises: [
      { name: "Squats", type: "BODYWEIGHT", sets: 4, minReps: 12, maxReps: 20, restTime: 90 },
      { name: "Bulgarian Split Squats", type: "BODYWEIGHT", sets: 3, minReps: 10, maxReps: 15, restTime: 90 },
      { name: "Romanian Deadlift", type: "WEIGHTED", sets: 3, minReps: 12, maxReps: 15, restTime: 90 },
      { name: "Calf Raises", type: "BODYWEIGHT", sets: 4, minReps: 15, maxReps: 25, restTime: 60 },
    ],
  },
  {
    name: "Full Body",
    ...
    sortOrder: 3,
    exercises: [
      { name: "Push-ups", type: "BODYWEIGHT", sets: 3, minReps: 10, maxReps: 15, restTime: 60 },
      { name: "Pull-ups", type: "BODYWEIGHT", sets: 3, minReps: 6, maxReps: 10, restTime: 60 },
      { name: "Squats", type: "BODYWEIGHT", sets: 3, minReps: 15, maxReps: 20, restTime: 60 },
      { name: "Plank", type: "TIMED", sets: 3, minReps: 30, maxReps: 60, restTime: 45 },
    ],
  },
];
